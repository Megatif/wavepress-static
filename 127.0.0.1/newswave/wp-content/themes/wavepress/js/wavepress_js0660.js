jQuery(function ($) {
  ...
  $(".image-switch").on("click", function () {
    window.location = "indexbc81.html?theme=image";
  });
  ...
  if ($.getQuery("theme") === "pill") {
    ...
    $("#scrollUpTheme").attr("href", "css/themes/pill777d.html?1.1");
    ...
    $("#scrollUpTheme").attr("href", "css/themes/link777d.html?1.1");
    ...
    $("#scrollUpTheme").attr("href", "css/themes/image777d.html?1.1");
    ...
    $("#scrollUpTheme").attr("href", "css/themes/tab777d.html?1.1");
  ...
  $( ".menu-toggle-button" ).on( "click" ,function() {
      ...
      $(this).toggleClass('menu-toggle-button-shape');
  });
